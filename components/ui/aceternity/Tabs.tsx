...
export const Tabs = ({
  ...
  return (
    <>
          ...
          >
            {active.value === tab.value && (
              <motion.div
                ...
                className={cn("absolute inset-0 bg-violet-700 dark:bg-zinc-800 rounded-full ", activeTabClassName)}
              />
            )}
      ...
      <FadeInDiv tabs={tabs} active={active} key={active.value} hovering={hovering} className={cn("mt-12", contentClassName)} />
    </>
  );
};
